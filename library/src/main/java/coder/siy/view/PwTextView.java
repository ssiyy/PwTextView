...
public class PwTextView extends TextView {
    ...
    public PwTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public PwTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static class TimerHandler extends Handler {
        ...
        TimerHandler(PwTextView view) {
            reference = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            PwTextView view = reference.get();
            if (view != null) {
